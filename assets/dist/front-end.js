(window["webpackJsonp_wsuwp_plugin_block_people_working"] = window["webpackJsonp_wsuwp_plugin_block_people_working"] || []).push([["style-front-end"],{
...
/******/ 	deferredModules.push(["./assets/src/front-end.js","style-front-end"]);
...
/***/ "./assets/src/blocks/logo-generator/front-end.js":
/*!*******************************************************!*\
  !*** ./assets/src/blocks/logo-generator/front-end.js ***!
  \*******************************************************/
/*! no exports provided */
...
function LogoCollection(el) {
  ...
  function resizeSVGs(referenceSVG, doc) {
    ...
    const height = width * hwRatio; // resize svg and container
  ...
  function bindEvents() {
    ...
    downloadButtons.forEach(button => {
      button.addEventListener('click', function () {
        ...
        html2canvas__WEBPACK_IMPORTED_MODULE_0___default()(svg.parentNode, {
          allowTaint: true,
      ...
      request.onloadend = function () {
        ...
        fontUrls.forEach(url => {
          ...
          request.onloadend = () => {
            ...
            reader.onloadend = () => {
              loaded++; // replace font url by binary string

              css = css.replace("url(\"", 'url('); // remove quote from url

              css = css.replace(url, reader.result); // check all fonts are replaced.
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _blocks_logo_generator_front_end__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./blocks/logo-generator/front-end */ "./assets/src/blocks/logo-generator/front-end.js");
